...
julia> upload_trial_data!(conn, fname=fname, species="Acacia neglecta", experiment="some-exp", treatment="some_trt", measurement_dates=measurement_dates, entry_type="family", population_type="population", relationship_type="member_of");
